$(document).ready(function () {
    ...
    $('#cercle_rempli').click(function(){reset();cercle_rempli = true;});
    $('#rectangle_rempli').click(function(){reset();rectangle_rempli = true;});
    ...
    $('#canvas').mousedown(function (e){
        if(crayon){
            ...
            mousePressed = false;
            draw(e.pageX-$(this).offset().left, e.pageY-$(this).offset().top, true);
        }else if(cercle_rempli){
            mousePressed = false;
            draw(e.pageX-$(this).offset().left, e.pageY-$(this).offset().top, true);
        }else if(rectangle_rempli){
            mousePressed = false;
            draw(e.pageX-$(this).offset().left, e.pageY-$(this).offset().top, true);
        }
